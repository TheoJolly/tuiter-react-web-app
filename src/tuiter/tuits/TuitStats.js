        ...
        <div>
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-2">
                        <div>
                            {post.liked ? <svg onClick={() => dispatch(updateTuitThunk({
                                    ...post,
                                    likes: post.likes + 1
                                }))} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" className="bi bi-heart-fill" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
                                          </svg>
                                          :
                                          <svg onClick={() => dispatch(updateTuitThunk({
                                            ...post,
                                            likes: post.likes + 1
                    ...
                    <div className="col-2">
                        <div>
                            <svg onClick={() => dispatch(updateTuitThunk({
                                ...
                                }))} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
